...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><a href="{{ url('players/') }}">Players</a><i class="fa fa-angle-right fa-fw"></i><a href="{{ url('players/' . $player->id) }}">{{ $player->first_name }} {{ $player->last_name }}</a><i class="fa fa-angle-right fa-fw"></i>Edit Player</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-users fa-fw"></i> Edit Player Information
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group @if ($errors->has('state')) has-error @endif">
                                    ...
                                    <div class="col-lg-8">
                                        {{ Form::select('state', $states, $player->state, array('class' => 'form-control')) }}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                {{ Form::submit('Update Player', array('class' => 'btn btn-info pull-right')) }}
                            </div>
                        </div>
                    </div>
